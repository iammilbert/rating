...
include ('db_connect.php');
  ...
  if(isset($_POST['submit'])){
    ...
    $motivation_questions = $_POST['motivation_questions'];

    $sql = "INSERT INTO motivation_questions(questions) VALUES('".$motivation_questions."')";
    ...
    <div class="col-md-6 col-md-offset-3">
        <form class="form" method="POST">
            <div class="form-group">
                 <label>Question (Motivation)</label>
                 <textarea name="motivation_questions" class="form-control"></textarea>
            </div>
