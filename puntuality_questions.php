...
include ('db_connect.php');
  ...
  if(isset($_POST['submit'])){
    ...
    $puntuality_questions = $_POST['puntuality_questions'];

    $sql = "INSERT INTO puntuality_questions(questions) VALUES('".$puntuality_questions."')";
    ...
    <div class="col-md-6 col-md-offset-3">
        <form class="form" method="POST">
            <div class="form-group">
                 <label>Question (Puntuality)</label>
                 <textarea name="puntuality_questions" class="form-control"></textarea>
            </div>
