...
include ('db_connect.php');
  ...
  if(isset($_POST['submit'])){
    ...
    $management_questions = $_POST['management_questions'];

    $sql = "INSERT INTO mgt_questions(questions) VALUES('".$management_questions."')";
    ...
    <div class="col-md-6 col-md-offset-3">
        <form class="form" method="POST">
            <div class="form-group">
                 ...
                 <textarea name="management_questions" class="form-control"></textarea>
            </div>
