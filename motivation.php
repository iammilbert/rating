...
<?php 
if (isset($_POST['mtv_submit'])) {

    $staff_id = $_GET['id'];
    $student_id = $_POST['student_id'];
            $check_duplicate_motivation = "SELECT student_id AND staff_id FROM motivation_answer WHERE student_id = '".$student_id."' AND staff_id = '".$staff_id."'";

            $query_motivation = mysqli_query($conn, $check_duplicate_motivation) or die(mysqli_error($conn));
            $motivation_count = mysqli_num_rows($query_motivation);
            if ($motivation_count > 0) {
                array_push($errors, "motivation answer already submitted, Please move to the next category!");
            }
...
if (count($errors)==0) {
    $sql = "INSERT INTO motivation_answer(student_id, staff_id, question1_choice, question2_choice, question3_choice, question4_choice, question5_choice, question6_choice, question7_choice) VALUES('".$student_id."', '".$staff_id."', '".$question1_choice."', '".$question2_choice."', '".$question3_choice."', '".$question4_choice."', '".$question5_choice."', '".$question6_choice."', '".$question7_choice."')";
        ...
        <div class="col-md-10">
         <form method="POST" style="text-align: justify; border-right: dashed;">
           <input type="hidden" name="student_id" value="<?php echo $_SESSION['id']; ?>">
            ...
            <label style="font-size: 20px; color: red"><u><b>MOTIVATION</b></u></label>
 <b><?php include ('signup_error.php'); ?></b>
            ...
            <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 1";
...
<hr>
             <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 2";
                    $query = mysqli_query($conn, $sql);
                ?>
...
<hr>
             <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 3";
                    $query = mysqli_query($conn, $sql);
                ?>
...
<hr>
            ...
            <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 4";
                    $query = mysqli_query($conn, $sql);
                ?>
...
<hr>
             <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 5";
                    $query = mysqli_query($conn, $sql);
                ?>
             ...
             <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 6";
                    $query = mysqli_query($conn, $sql);
                ?>
...
<hr>
             <div class="form-group">
                 <?php
                    ...
                    $sql = "SELECT * FROM motivation_questions WHERE id = 7";
                    $query = mysqli_query($conn, $sql);
                ?>
            ...
            <div style="padding-bottom: 20px; padding-top: 20px">
                <input type="submit" name="mtv_submit" value="Submit" class="btn btn-primary" style="background-color: darkorange; border-color: darkorange; font-size: 17px">

               
                <a href="view_questionaire.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary" style="background-color: darkorange; border-color: darkorange; font-size: 17px">Back</a> 

                <a href="view_questionaire_instruction_curriculum.php?id=<?php echo $_GET['id']; ?>" class="btn btn-primary" style="background-color: darkorange; border-color: darkorange; font-size: 17px">Next Category</a>
            </div>
