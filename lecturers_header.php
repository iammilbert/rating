            ...
            <div class="container-fluid">       
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item active"><a class="nav-link" href="lecturers_page.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="student_logout.php">Logout</a></li>
                         <li class="nav-item"><a class="nav-link" href="view_performance.php">Result</a></li>
                          <li class="nav-item"><a class="nav-link" href="lecturers_profile.php">My Profile</a></li>
                    </ul>
                </div>
            </div>
        </nav>
