...
<?php 
		...
		$sql = "SELECT * FROM admin WHERE userName = 'gadmin' AND password = '".$password."'";
		...
		header('Location: general_admin_page.php');
	...
	<div class="row">
        ...
        <?php endif ?>
				<fieldset>
						...
						<legend style="color: darkgreen;"><b>General Admin Login</b></legend>
